          ...
          <SheetContent>
            <SheetHeader>
              <SheetTitle>
                ...
                <Input type="text" placeholder="Enter Description.." value= {desc} className="font-['Urbanist'] text-sm font-medium leading-4.5 text-left text-rgba-63-61-86 h-56 py-1.5" onChange={(e) => { setDesc(e.target.value) }} />
              </SheetTitle>
              <SheetDescription>
                <div>
